                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label mb-0">Bulan Tahun</label>
                            <input class="form-control datePicker" name="bln" type="text" value="{{ @$data['bulan'].'-'.@$data['tahun'] }}" readonly>
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label mb-0">Jumlah Hari Kerja</label>
                            <input type="number" value="{{ @$data['jml_hari_kerja']}}" name="jml_hari_kerja" class="form-control" autocomplete="off" />
                        </div>
