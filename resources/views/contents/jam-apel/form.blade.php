                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" value="{{ @$data['jam_apel_pagi']}}" name="jam_apel_pagi" class="form-control datePicker" autocomplete="off" />
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label mb-0">Maksimal Jam Apel Pagi</label>
                            <input type="text" value="{{ @$data['max_apel_pagi']}}" name="max_apel_pagi" class="form-control datePicker" autocomplete="off" />
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label mb-0">Jam Apel Sore</label>
                            <input type="text" value="{{ @$data['jam_apel_sore']}}" name="jam_apel_sore" class="form-control datePicker" autocomplete="off" />
                        </div>
                        <div class="form-group mb-4">
                            <label class="form-label mb-0">Maksimal Jam Apel Sore</label>
                            <input type="text" value="{{ @$data['max_apel_sore']}}" name="max_apel_sore" class="form-control datePicker" autocomplete="off" />
                        </div>
